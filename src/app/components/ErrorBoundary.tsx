            ...
            <div className="text-center">
              ...
              {error && (
                <details className="mb-6 text-left">
                  ...
                  <div className="mt-2 p-3 bg-gray-100 dark:bg-gray-700 rounded-sm text-xs font-mono text-red-600 dark:text-red-400 overflow-auto max-h-32">
              ...
              <button
                ...
                className="ml-3 px-6 py-2 bg-gray-500 dark:bg-gray-600 text-white rounded-lg hover:bg-gray-600 dark:hover:bg-gray-700 transition-colors"
              >
                Reload Page
              </button>
            </div>
