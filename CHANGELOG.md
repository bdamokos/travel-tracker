...
[Full Changelog](https://github.com/bdamokos/travel-tracker/compare/998865af46506372c5c4ae1f66b5873314819247...HEAD)
...
- Expense editors now support cash allocation segments, exchange rate displays, and segmented date inputs for consistent entry workflows.
- Map and popup stack rebuilt around a shared modal with grouped markers, spiderfy interactions, richer Wikipedia extracts, and transition-day weather hints.
- Weather services enforce stay-window filtering, smarter caching, and clearer fallback labeling across APIs and UI surfaces.
- Shadow planner flows merge real and draft data with geocoding, styling, and accommodation management updates.

### Fixed
- Resolved Instagram and TikTok icon rendering in client-only popups and embeddable maps.
- Patched build and schema issues including temp-location accommodation references and null-safe linked expense filtering.
- Normalized date handling across calendars and cost summaries to eliminate UTC-related regressions.
...
**Auto-generated historical notes**
...
\* *Legacy sections above were originally generated by [github_changelog_generator](https://github.com/github-changelog-generator/github-changelog-generator).*
